...
wk.add({
    ...
    { "<leader>pb", "<cmd>lua require('FTerm').scratch({cmd = {'pytest', '-sv', '--disable-pytest-warnings', '--cov', get_pytest_cov_cmd(), '--cov-branch', vim.fn.expand('%:p'), '--cov-report', 'term-missing'}, hl = 'Normal,FloatBorder:FzfLuaBorder', border = 'rounded'})<CR>", desc = "branch coverage" },
    { "<leader>pc", "<cmd>lua require('FTerm').scratch({cmd = {'pytest', '-sv', '--disable-pytest-warnings', '--cov', get_pytest_cov_cmd(), vim.fn.expand('%:p'), '--cov-report', 'term-missing'}, hl = 'Normal,FloatBorder:FzfLuaBorder', border = 'rounded'})<CR>", desc = "file coverage" },
    { "<leader>pl", "<cmd>lua require('FTerm').scratch({cmd = {'pytest', '-sv', '--disable-pytest-warnings', get_last_test_name()}, hl = 'Normal,FloatBorder:FzfLuaBorder', border = 'rounded'})<CR>", desc = "last-run test" },
    ...
    { "<leader>pz", "<cmd>lua require('FTerm').scratch({cmd = {'pytest', '-sv', '--disable-pytest-warnings', get_pytest_single_test_arg()}, hl = 'Normal,FloatBorder:FzfLuaBorder', border = 'rounded'})<CR>", desc = "under cursor" },
    ...
    { "<leader>tf", "<cmd>lua require('FTerm').toggle()<CR>", desc = "floating window" },
